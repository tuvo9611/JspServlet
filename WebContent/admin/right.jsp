<%-- 
    Document   : right
    Created on : May 9, 2017, 10:43:42 AM
    Author     : Nguyen
--%>
    ...
    <body>
        <div id="rightContent">
            ...
            <div class="shortcutHome">
                <a href=""><img src="../css/img/posting.png"><br>Tambah Posting</a>
            </div>
            <div class="shortcutHome">
                <a href=""><img src="css/img/photo.png"><br>Upload Foto</a>
            </div>
            <div class="shortcutHome">
                <a href=""><img src="css/mos-css/img/halaman.png"><br>Tambah Halaman</a>
            </div>
            <div class="shortcutHome">
                <a href=""><img src="mos-css/img/template.png"><br>Pengaturan Template</a>
            </div>
            <div class="shortcutHome">
                <a href=""><img src="css/mos-css/img/quote.png"><br>Tambah QOD</a>
            </div>
            <div class="shortcutHome">
