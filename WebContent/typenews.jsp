                ...
                <div class="col-sm-9">
                    <div class="blog-post-area">
                        ...
                        <div class="single-blog-post">
                            ...
                            <a href="">
                                <%-- <img style="width:600px;height: 300px"  src="<%request.getContextPath();%><%=tt.getHinh_anh() %>" alt=""> --%>
<%--                                 <img style="width:600px;height: 300px"  src="<%=tt.getHinh_anh()%>" alt=""> --%>
								<img src="data:image/jpg;base64,<%=tt.getHinh_anh()%>" width="100%" height="450px"/>
                            </a>
                            <p><%=tt.getTieu_de()%></p>
